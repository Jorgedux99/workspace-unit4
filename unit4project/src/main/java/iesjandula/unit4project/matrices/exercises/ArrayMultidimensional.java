...
public class ArrayMultidimensional {
	...
	public static void main(String[] args) {
		...
		double[][] tempsCuatroSemanas = { { 30, 28, 27, 20, 25, 26, 27 }, { 20, 21, 24, 25, 26, 23, 24 },
											{ 20, 21, 24, 25, 26, 23, 24 }, { 20, 21, 24, 25, 26, 23, 24 } };
		...
		for (int i = 0; i < tempsCuatroSemanas[0].length; i++) {
			...
			media = media / 7;
			System.out.println("La media de los dias  " + DiasSemana.values()[i] + " es " + media);
		}
