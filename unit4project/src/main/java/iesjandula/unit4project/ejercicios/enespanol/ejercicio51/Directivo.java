...
public class Directivo extends Empleado {
	...
	public Directivo(String nombre, String apellidos, String nif, int antigüedad, double salario, double bonusPorcentaje, double beneficiosDep) {
	...
	public EnumCategoria tipoEmpleado() {
		...
		return EnumCategoria.DIRECTIVOS;
	}
